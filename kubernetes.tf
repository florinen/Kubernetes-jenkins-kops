...
resource "aws_key_pair" "kubernetes-novdevterraform-com-258c4cae3fa2f240f6d858e46d42a209" {
  key_name   = "kubernetes.novdevterraform.com-25:8c:4c:ae:3f:a2:f2:40:f6:d8:58:e4:6d:42:a2:09"
  public_key = "${file("${path.module}/data/aws_key_pair_kubernetes.novdevterraform.com-258c4cae3fa2f240f6d858e46d42a209_public_key")}"
}
...
resource "aws_launch_configuration" "bastions-novdevterraform-com" {
  ...
  key_name                    = "${aws_key_pair.kubernetes-novdevterraform-com-258c4cae3fa2f240f6d858e46d42a209.id}"
